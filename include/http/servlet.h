#ifndef __FANSHUTOU_HTTP_SERVLET_H__
#define __FANSHUTOU_HTTP_SERVLET_H__
...
public:
    ...
    virtual int32_t handle(fst::http::HttpRequest::ptr request
                   , fst::http::HttpResponse::ptr response
                   , fst::http::HttpSession::ptr session) = 0;
...
public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t (fst::http::HttpRequest::ptr request
                   , fst::http::HttpResponse::ptr response
                   , fst::http::HttpSession::ptr session)> callback;


    FunctionServlet(callback cb);
    virtual int32_t handle(fst::http::HttpRequest::ptr request
                   , fst::http::HttpResponse::ptr response
                   , fst::http::HttpSession::ptr session) override;
private:
    /// 回调函数
    callback m_cb;
};
