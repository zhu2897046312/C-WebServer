#ifndef __FANSHUTOU_TCP_SERVER_H__
#define __FANSHUTOU_TCP_SERVER_H__
...
public:
    ...
    TcpServer(fst::IOManager* worker = fst::IOManager::GetThis()
              ,fst::IOManager* io_woker = fst::IOManager::GetThis()
              ,fst::IOManager* accept_worker = fst::IOManager::GetThis());

    virtual ~TcpServer();

    virtual bool bind(fst::Address::ptr addr, bool ssl = false);
