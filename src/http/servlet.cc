...
int32_t FunctionServlet::handle(fst::http::HttpRequest::ptr request
               , fst::http::HttpResponse::ptr response
               , fst::http::HttpSession::ptr session) {
...
ServletDispatch::ServletDispatch()
    ...
    m_default.reset(new NotFoundServlet("fst/1.0"));
}

int32_t ServletDispatch::handle(fst::http::HttpRequest::ptr request
               , fst::http::HttpResponse::ptr response
               , fst::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(fst::http::HttpRequest::ptr request
                   , fst::http::HttpResponse::ptr response
                   , fst::http::HttpSession::ptr session) {
    response->setStatus(fst::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "fst/1.0.0");
